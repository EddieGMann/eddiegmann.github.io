        ...
        <div style="text-align: center;">
          ...
          <input type="number" id="input-${item}" placeholder="Amount" min="1"
            style="width: 75px; margin-top: 10px;" />
            		<button style = "background-color: red; color: white; border: none; order-radius: 50%; width: 24px; height: 24px; font-size: 14px; margin-left: 12px; cursor: pointer;">✕</button>
        </div>
      </div>
    `;
